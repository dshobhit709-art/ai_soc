...
|---------|--------------|----------------|---------------------|
| CICIDS2017 | Free | Check terms | Yes |
| UNSW-NB15 | Free | No | Yes |
| CICIoT2023 | Free | Check terms | Yes |
...
**Need help?** Open an issue on GitHub or contact Shobhit Dixit (dshobhit709@gmail.com) for assistance.

---

## About the Maintainer

This project is currently maintained by Shobhit Dixit, an AI/ML Engineer with experience in building and deploying machine learning and generative AI systems.

-   **GitHub:** [Shobhit Dixit](https://github.com/dshobhit709)
-   **LinkedIn:** [Shobhit Dixit](https://www.linkedin.com/in/shobhit-dixit)
